...
const OffersPageSection = () => {
  ...
  return (
    <section className="bg-mainBg py-16">
        <div className="max-w-[1200px] mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-10 items-center p-6 md:p-10">
                ...
                <div>
                    ...
                    <button className="flex justify-center gap-4 mb-8 flex-wrap">
      ...
      {/* ================= Image ================= */}
      <img
        src="https://nvskwcjdrrrcpyiadoxy.supabase.co/storage/v1/object/public/Riad%20Al%20Assala%20Fes/Images%20of%20the%20pages/Offres/_DSC1964-HDR.png"
        alt="Fes Medina"
