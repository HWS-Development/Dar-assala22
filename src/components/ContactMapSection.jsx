...
const ContactMapSection = () => {
  ...
  let hotelName = t("contact.hotelName"); // default

  if (location.pathname.includes("/dining/leVerdoyant")) {
    hotelName = t("leVerdoyant.title");
  } else if (location.pathname.includes("/dining/LeVerdoyantRooftop")) {
    hotelName = t("leVerdoyantRooftop.title");
  } else if (location.pathname.includes("/dining/LeVerdoyantCoffeeShop")) {
    hotelName = t("leVerdoyantCoffeeShop.title");
  }
  ...
  return (
    <section id="contact" className="bg-mainBg py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              >
                <div className="w-6 h-6 rounded-full border border-[#1a1a1a] hover:bg-[#25D366] hover:border-[#25D366] transition flex items-center justify-center">
                  <Phone size={14} className="text-[#1a1a1a]" />
                </div>

                <p className="text-base text-[#1a1a1a] hover:text-[#25D366]">
                  {t("contact.phone")}
                </p>
              </a>
            </div>
